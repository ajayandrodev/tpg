...
public class ReportParticulrEroDepositsSortNew implements Parcelable {
    ...
    public ReportParticulrEroDepositsSortNew() {
    }

    protected ReportParticulrEroDepositsSortNew(Parcel in) {
    ...
    public static final Creator<ReportParticulrEroDepositsSortNew> CREATOR = new Creator<ReportParticulrEroDepositsSortNew>() {
        @Override
        public ReportParticulrEroDepositsSortNew createFromParcel(Parcel source) {
            return new ReportParticulrEroDepositsSortNew(source);
        }

        @Override
        public ReportParticulrEroDepositsSortNew[] newArray(int size) {
            return new ReportParticulrEroDepositsSortNew[size];
        }
    };
}