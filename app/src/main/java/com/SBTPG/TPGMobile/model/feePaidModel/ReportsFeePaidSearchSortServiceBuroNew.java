...
public class ReportsFeePaidSearchSortServiceBuroNew implements Parcelable {
    ...
    public ReportsFeePaidSearchSortServiceBuroNew() {

    }

    protected ReportsFeePaidSearchSortServiceBuroNew(Parcel in) {
        Id = in.readString();
    ...
    public static final Creator<ReportsFeePaidSearchSortServiceBuroNew> CREATOR = new Creator<ReportsFeePaidSearchSortServiceBuroNew>() {
        @Override
        public ReportsFeePaidSearchSortServiceBuroNew createFromParcel(Parcel in) {
            return new ReportsFeePaidSearchSortServiceBuroNew(in);
        }

        @Override
        public ReportsFeePaidSearchSortServiceBuroNew[] newArray(int size) {
            return new ReportsFeePaidSearchSortServiceBuroNew[size];
        }
    };
