...
public class ReportAccountDisbServiceBuroSearchSortNew implements Parcelable {
    @SerializedName("Id")
    private String Id;
    ...
    protected ReportAccountDisbServiceBuroSearchSortNew(Parcel in) {
        Id = in.readString();
    ...
    public static final Creator<ReportAccountDisbServiceBuroSearchSortNew> CREATOR = new Creator<ReportAccountDisbServiceBuroSearchSortNew>() {
        @Override
        public ReportAccountDisbServiceBuroSearchSortNew createFromParcel(Parcel in) {
            return new ReportAccountDisbServiceBuroSearchSortNew(in);
        }

        @Override
        public ReportAccountDisbServiceBuroSearchSortNew[] newArray(int size) {
            return new ReportAccountDisbServiceBuroSearchSortNew[size];
        }
    };
    ...
    public ReportAccountDisbServiceBuroSearchSortNew() {
