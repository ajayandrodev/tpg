...
public class ReportsFeePaidSearchNew implements Parcelable {
    ...
    public ReportsFeePaidSearchNew() {
    }

    protected ReportsFeePaidSearchNew(Parcel in) {
        Id = in.readString();
    ...
    public static final Creator<ReportsFeePaidSearchNew> CREATOR = new Creator<ReportsFeePaidSearchNew>() {
        @Override
        public ReportsFeePaidSearchNew createFromParcel(Parcel in) {
            return new ReportsFeePaidSearchNew(in);
        }

        @Override
        public ReportsFeePaidSearchNew[] newArray(int size) {
            return new ReportsFeePaidSearchNew[size];
        }
    };
