...
public class ReportsFeePaidSortServiceBuroNew implements Parcelable {
    @SerializedName("Id")
    private String Id;
    ...
    protected ReportsFeePaidSortServiceBuroNew(Parcel in) {
        Id = in.readString();
    ...
    public static final Creator<ReportsFeePaidSortServiceBuroNew> CREATOR = new Creator<ReportsFeePaidSortServiceBuroNew>() {
        @Override
        public ReportsFeePaidSortServiceBuroNew createFromParcel(Parcel in) {
            return new ReportsFeePaidSortServiceBuroNew(in);
        }

        @Override
        public ReportsFeePaidSortServiceBuroNew[] newArray(int size) {
            return new ReportsFeePaidSortServiceBuroNew[size];
        }
    };
