...
public class ReportParticulrFreePaidSearchSortNew implements Parcelable {
    ...
    public static final Creator<ReportParticulrFreePaidSearchSortNew> CREATOR = new Creator<ReportParticulrFreePaidSearchSortNew>() {
        @Override
        public ReportParticulrFreePaidSearchSortNew createFromParcel(Parcel in) {
            return new ReportParticulrFreePaidSearchSortNew(in);
        }

        @Override
        public ReportParticulrFreePaidSearchSortNew[] newArray(int size) {
            return new ReportParticulrFreePaidSearchSortNew[size];
        }
    };
}
