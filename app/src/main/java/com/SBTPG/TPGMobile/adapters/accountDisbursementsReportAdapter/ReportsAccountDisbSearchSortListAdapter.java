...
public class ReportsAccountDisbSearchSortListAdapter extends RecyclerView.Adapter<ReportsAccountDisbSearchSortListAdapter.ReportsViewHolder> {
    List<ReportAccountDisbSearchSortNew> reportsList;
    String title;
    ...
    @Override
    public ReportsAccountDisbSearchSortListAdapter.ReportsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_list_row, parent, false);
        ReportsAccountDisbSearchSortListAdapter.ReportsViewHolder reportsViewHolder
                = new ReportsAccountDisbSearchSortListAdapter.ReportsViewHolder(itemView);
        return reportsViewHolder;
    }

    @Override
    public void onBindViewHolder(ReportsAccountDisbSearchSortListAdapter.ReportsViewHolder holder, int position) {
