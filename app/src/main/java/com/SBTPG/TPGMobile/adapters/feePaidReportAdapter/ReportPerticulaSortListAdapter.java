...
public class ReportPerticulaSortListAdapter extends RecyclerView.Adapter<ReportPerticulaSortListAdapter.ReportsViewHolder> {
    List<ReportParticulrFreePaidSortNew> reportsList;
    String title;
    private ItemClickListener clickListener;
    String index;
    Context mContext;

    public ReportPerticulaSortListAdapter(Context mContext, List<ReportParticulrFreePaidSortNew> reportsList, String title) {
