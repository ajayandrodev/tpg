...
public class ReportsFeesPaidServiceBuroSortListAdapter extends RecyclerView.Adapter<ReportsFeesPaidServiceBuroSortListAdapter.ReportsViewHolder> {
    List<ReportsFeePaidSortServiceBuroNew> reportsList;
    String title;
    private ItemClickListener clickListener;
    String index;
    Context mContext;

    public ReportsFeesPaidServiceBuroSortListAdapter(Context mContext, List<ReportsFeePaidSortServiceBuroNew> reportsList, String title) {
    ...
    @Override
    public ReportsFeesPaidServiceBuroSortListAdapter.ReportsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_list_row, parent, false);
        ReportsFeesPaidServiceBuroSortListAdapter.ReportsViewHolder reportsViewHolder
                = new ReportsFeesPaidServiceBuroSortListAdapter.ReportsViewHolder(itemView);
        return reportsViewHolder;
    }

    @Override
    public void onBindViewHolder(ReportsFeesPaidServiceBuroSortListAdapter.ReportsViewHolder holder, int position) {
        ReportsFeePaidSortServiceBuroNew reports = reportsList.get(position);
