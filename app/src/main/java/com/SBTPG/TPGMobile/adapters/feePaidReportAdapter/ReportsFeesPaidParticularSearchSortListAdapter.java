...
import com.SBTPG.TPGMobile.model.feePaidModel.ReportParticulrFreePaidSearchSortNew;
...
public class ReportsFeesPaidParticularSearchSortListAdapter extends RecyclerView.Adapter<ReportsFeesPaidParticularSearchSortListAdapter.ReportsViewHolder> {
    List<ReportParticulrFreePaidSearchSortNew> reportsList;
    String title;
    private ItemClickListener clickListener;
    String index;
    Context mContext;

    public ReportsFeesPaidParticularSearchSortListAdapter(Context mContext, List<ReportParticulrFreePaidSearchSortNew> reportsList, String title) {
    ...
    @Override
    public ReportsFeesPaidParticularSearchSortListAdapter.ReportsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_list_row, parent, false);
        ReportsFeesPaidParticularSearchSortListAdapter.ReportsViewHolder reportsViewHolder
                = new ReportsFeesPaidParticularSearchSortListAdapter.ReportsViewHolder(itemView);
