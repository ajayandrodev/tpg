...
public class ReportsFeesPaidServiceBuroListAdapter  extends RecyclerView.Adapter<ReportsFeesPaidServiceBuroListAdapter.ReportsViewHolder> {
    List<ReportsFeePaidServiceBuroNew> reportsList;
    String title;
    private ItemClickListener clickListener;
    Context mContext;

    public ReportsFeesPaidServiceBuroListAdapter(Context mContext, List<ReportsFeePaidServiceBuroNew> reportsList,String title) {
    ...
    @Override
    public void onBindViewHolder(ReportsFeesPaidServiceBuroListAdapter.ReportsViewHolder holder, int position) {
        ReportsFeePaidServiceBuroNew reports = reportsList.get(position);
