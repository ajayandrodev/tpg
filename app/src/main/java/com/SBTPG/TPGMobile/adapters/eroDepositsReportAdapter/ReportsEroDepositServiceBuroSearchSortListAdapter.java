...
public class ReportsEroDepositServiceBuroSearchSortListAdapter extends RecyclerView.Adapter<ReportsEroDepositServiceBuroSearchSortListAdapter.ReportsViewHolder> {
    List<ReportEroDepositsServiceBuroSearchSortNew> reportsList;
    String title;
    private ItemClickListener clickListener;
    Context mContext;

    public ReportsEroDepositServiceBuroSearchSortListAdapter(Context mContext, List<ReportEroDepositsServiceBuroSearchSortNew> reportsList, String title) {
    ...
    @Override
    public ReportsEroDepositServiceBuroSearchSortListAdapter.ReportsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_list_row, parent, false);
        ReportsEroDepositServiceBuroSearchSortListAdapter.ReportsViewHolder reportsViewHolder = new ReportsEroDepositServiceBuroSearchSortListAdapter.ReportsViewHolder(itemView);
