...
public class ReportsAccountDisbSearchListAdapter extends RecyclerView.Adapter<ReportsAccountDisbSearchListAdapter.ReportsViewHolder> {
    List<ReportAccountDisbSearchNew> reportsList;
    String title;
    ...
    @Override
    public ReportsAccountDisbSearchListAdapter.ReportsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_list_row, parent, false);
        ReportsAccountDisbSearchListAdapter.ReportsViewHolder reportsViewHolder
                = new ReportsAccountDisbSearchListAdapter.ReportsViewHolder(itemView);
        return reportsViewHolder;
    }

    @Override
    public void onBindViewHolder(ReportsAccountDisbSearchListAdapter.ReportsViewHolder holder, int position) {
