...
import com.SBTPG.TPGMobile.adapters.eroDepositsReportAdapter.SbiEroListDataAdapter;
...
public class ReportsEroDepositServiceBuroFragment extends Fragment implements RemoveClickListner, ExpandableListView.OnChildClickListener {
    ...
    public static Fragment newInstance(String sectionTitle, String userId, String type) {
        ReportsEroDepositServiceBuroFragment fragment = new ReportsEroDepositServiceBuroFragment();
