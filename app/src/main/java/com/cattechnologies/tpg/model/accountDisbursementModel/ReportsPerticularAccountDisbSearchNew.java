...
public class ReportsPerticularAccountDisbSearchNew implements Parcelable {
    ...
    public static final Creator<ReportsPerticularAccountDisbSearchNew> CREATOR = new Creator<ReportsPerticularAccountDisbSearchNew>() {
        @Override
        public ReportsPerticularAccountDisbSearchNew createFromParcel(Parcel source) {
            return new ReportsPerticularAccountDisbSearchNew(source);
        }

        @Override
        public ReportsPerticularAccountDisbSearchNew[] newArray(int size) {
            return new ReportsPerticularAccountDisbSearchNew[size];
        }
    };
}
