...
public class ReportParticulrAccountDisbSearchSortNew implements Parcelable {
    ...
    public ReportParticulrAccountDisbSearchSortNew() {
    }

    protected ReportParticulrAccountDisbSearchSortNew(Parcel in) {
    ...
    public static final Creator<ReportParticulrAccountDisbSearchSortNew> CREATOR = new Creator<ReportParticulrAccountDisbSearchSortNew>() {
        @Override
        public ReportParticulrAccountDisbSearchSortNew createFromParcel(Parcel source) {
            return new ReportParticulrAccountDisbSearchSortNew(source);
        }

        @Override
        public ReportParticulrAccountDisbSearchSortNew[] newArray(int size) {
            return new ReportParticulrAccountDisbSearchSortNew[size];
        }
    };
}
