...
public class ReportParticulrAccountDisbSortNew implements Parcelable {
    @SerializedName("Id")
    private String Id;
    ...
    public static final Creator<ReportParticulrAccountDisbSortNew> CREATOR = new Creator<ReportParticulrAccountDisbSortNew>() {
        ...
        @Override
        public ReportParticulrAccountDisbSortNew[] newArray(int size) {
            return new ReportParticulrAccountDisbSortNew[size];
        }
    };
}