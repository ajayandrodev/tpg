...
public class ReportEroDepositsServiceBuroSearchNew implements Parcelable {
    ...
    public ReportEroDepositsServiceBuroSearchNew() {

    }

    protected ReportEroDepositsServiceBuroSearchNew(Parcel in) {
        Id = in.readString();
    ...
    public static final Creator<ReportEroDepositsServiceBuroSearchNew> CREATOR = new Creator<ReportEroDepositsServiceBuroSearchNew>() {
        @Override
        public ReportEroDepositsServiceBuroSearchNew createFromParcel(Parcel in) {
            return new ReportEroDepositsServiceBuroSearchNew(in);
        }

        @Override
        public ReportEroDepositsServiceBuroSearchNew[] newArray(int size) {
            return new ReportEroDepositsServiceBuroSearchNew[size];
        }
    };
