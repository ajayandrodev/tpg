...
public class ReportsPerticularEroDepositsSearchNew implements Parcelable {
    ...
    public ReportsPerticularEroDepositsSearchNew() {
    }

    protected ReportsPerticularEroDepositsSearchNew(Parcel in) {
    ...
    public static final Creator<ReportsPerticularEroDepositsSearchNew> CREATOR = new Creator<ReportsPerticularEroDepositsSearchNew>() {
        @Override
        public ReportsPerticularEroDepositsSearchNew createFromParcel(Parcel source) {
            return new ReportsPerticularEroDepositsSearchNew(source);
        }

        @Override
        public ReportsPerticularEroDepositsSearchNew[] newArray(int size) {
            return new ReportsPerticularEroDepositsSearchNew[size];
        }
    };
}
