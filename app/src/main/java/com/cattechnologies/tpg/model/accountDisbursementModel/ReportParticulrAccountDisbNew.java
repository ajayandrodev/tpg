...
public class ReportParticulrAccountDisbNew implements Parcelable {
    ...
    public static final Creator<ReportParticulrAccountDisbNew> CREATOR = new Creator<ReportParticulrAccountDisbNew>() {
        @Override
        public ReportParticulrAccountDisbNew createFromParcel(Parcel source) {
            return new ReportParticulrAccountDisbNew(source);
        }

        @Override
        public ReportParticulrAccountDisbNew[] newArray(int size) {
            return new ReportParticulrAccountDisbNew[size];
        }
    };
}