...
public class ReportEroDepositsServiceBuroSearchSortNew implements Parcelable {
    ...
    protected ReportEroDepositsServiceBuroSearchSortNew(Parcel in) {
        Id = in.readString();
    ...
    public static final Creator<ReportEroDepositsServiceBuroSearchSortNew> CREATOR = new Creator<ReportEroDepositsServiceBuroSearchSortNew>() {
        @Override
        public ReportEroDepositsServiceBuroSearchSortNew createFromParcel(Parcel in) {
            return new ReportEroDepositsServiceBuroSearchSortNew(in);
        }

        @Override
        public ReportEroDepositsServiceBuroSearchSortNew[] newArray(int size) {
            return new ReportEroDepositsServiceBuroSearchSortNew[size];
        }
    };
