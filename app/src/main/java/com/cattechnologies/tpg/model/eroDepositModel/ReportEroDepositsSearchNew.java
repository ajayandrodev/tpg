...
public class ReportEroDepositsSearchNew implements Parcelable {
    ...
    public ReportEroDepositsSearchNew() {
    }
    ...
    protected ReportEroDepositsSearchNew(Parcel in) {
    ...
    public static final Creator<ReportEroDepositsSearchNew> CREATOR = new Creator<ReportEroDepositsSearchNew>() {
        @Override
        public ReportEroDepositsSearchNew createFromParcel(Parcel source) {
            return new ReportEroDepositsSearchNew(source);
        }

        @Override
        public ReportEroDepositsSearchNew[] newArray(int size) {
            return new ReportEroDepositsSearchNew[size];
        }
    };
}
