...
public class ReportsAccountDisbServiceBuroSortNew implements Parcelable{
    @SerializedName("Id")
    private String Id;
    ...
    protected ReportsAccountDisbServiceBuroSortNew(Parcel in) {
        Id = in.readString();
    ...
    public static final Creator<ReportsAccountDisbServiceBuroSortNew> CREATOR = new Creator<ReportsAccountDisbServiceBuroSortNew>() {
        @Override
        public ReportsAccountDisbServiceBuroSortNew createFromParcel(Parcel in) {
            return new ReportsAccountDisbServiceBuroSortNew(in);
        }

        @Override
        public ReportsAccountDisbServiceBuroSortNew[] newArray(int size) {
            return new ReportsAccountDisbServiceBuroSortNew[size];
        }
    };
    ...
    public ReportsAccountDisbServiceBuroSortNew(){
