...
public class ReportsAccountDisbSortNew implements Parcelable {
    ...
    public static final Creator<ReportsAccountDisbSortNew> CREATOR = new Creator<ReportsAccountDisbSortNew>() {
        @Override
        public ReportsAccountDisbSortNew createFromParcel(Parcel source) {
            return new ReportsAccountDisbSortNew(source);
        }

        @Override
        public ReportsAccountDisbSortNew[] newArray(int size) {
            return new ReportsAccountDisbSortNew[size];
        }
    };
}
