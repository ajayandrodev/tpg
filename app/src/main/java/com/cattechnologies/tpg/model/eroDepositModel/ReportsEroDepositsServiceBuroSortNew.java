...
public class ReportsEroDepositsServiceBuroSortNew implements Parcelable{
    ...
    protected ReportsEroDepositsServiceBuroSortNew(Parcel in) {
        Id = in.readString();
    ...
    public static final Creator<ReportsEroDepositsServiceBuroSortNew> CREATOR = new Creator<ReportsEroDepositsServiceBuroSortNew>() {
        @Override
        public ReportsEroDepositsServiceBuroSortNew createFromParcel(Parcel in) {
            return new ReportsEroDepositsServiceBuroSortNew(in);
        }

        @Override
        public ReportsEroDepositsServiceBuroSortNew[] newArray(int size) {
            return new ReportsEroDepositsServiceBuroSortNew[size];
        }
    };
