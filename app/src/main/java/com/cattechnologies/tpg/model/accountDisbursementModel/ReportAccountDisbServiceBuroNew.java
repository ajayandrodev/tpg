...
public class ReportAccountDisbServiceBuroNew implements Parcelable {
    @SerializedName("Id")
    private String Id;
    ...
    protected ReportAccountDisbServiceBuroNew(Parcel in) {
        Id = in.readString();
    ...
    public static final Creator<ReportAccountDisbServiceBuroNew> CREATOR = new Creator<ReportAccountDisbServiceBuroNew>() {
        @Override
        public ReportAccountDisbServiceBuroNew createFromParcel(Parcel in) {
            return new ReportAccountDisbServiceBuroNew(in);
        }

        @Override
        public ReportAccountDisbServiceBuroNew[] newArray(int size) {
            return new ReportAccountDisbServiceBuroNew[size];
        }
    };
    ...
    public ReportAccountDisbServiceBuroNew() {
