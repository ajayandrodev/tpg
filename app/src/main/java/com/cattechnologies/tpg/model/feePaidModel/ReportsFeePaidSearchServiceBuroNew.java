...
public class ReportsFeePaidSearchServiceBuroNew implements Parcelable {
    ...
    public static final Creator<ReportsFeePaidSearchServiceBuroNew> CREATOR = new Creator<ReportsFeePaidSearchServiceBuroNew>() {
        @Override
        public ReportsFeePaidSearchServiceBuroNew createFromParcel(Parcel in) {
            return new ReportsFeePaidSearchServiceBuroNew(in);
        }

        @Override
        public ReportsFeePaidSearchServiceBuroNew[] newArray(int size) {
            return new ReportsFeePaidSearchServiceBuroNew[size];
        }
    };
