...
public class ReportAccountDisbSearchSort implements Parcelable {
    ...
    private List<ReportAccountDisbSearchSortNew> EroReport_data;
    ...
    public List<ReportAccountDisbSearchSortNew> getEroReport_data() {
        return EroReport_data;
    }

    public void setEroReport_data(List<ReportAccountDisbSearchSortNew> eroReport_data) {
    ...
    protected ReportAccountDisbSearchSort(Parcel in) {
        ...
        EroReport_data = in.createTypedArrayList(ReportAccountDisbSearchSortNew.CREATOR);
    }
