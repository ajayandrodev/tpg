...
public class ReportFreePaidSearchSortNew implements Parcelable {
    ...
    public ReportFreePaidSearchSortNew() {
    ...
    protected ReportFreePaidSearchSortNew(Parcel in) {
        Id = in.readString();
    ...
    public static final Creator<ReportFreePaidSearchSortNew> CREATOR = new Creator<ReportFreePaidSearchSortNew>() {
        @Override
        public ReportFreePaidSearchSortNew createFromParcel(Parcel in) {
            return new ReportFreePaidSearchSortNew(in);
        }

        @Override
        public ReportFreePaidSearchSortNew[] newArray(int size) {
            return new ReportFreePaidSearchSortNew[size];
        }
    };
}