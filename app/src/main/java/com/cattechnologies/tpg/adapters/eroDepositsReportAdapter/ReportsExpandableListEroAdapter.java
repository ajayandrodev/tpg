...
import com.cattechnologies.tpg.model.feePaidModel.FeesPaidChildInfo;
import com.cattechnologies.tpg.model.feePaidModel.FeesPaidGroupInfo;
...
public class ReportsExpandableListEroAdapter extends BaseExpandableListAdapter {

    private Context context;
    private ArrayList<FeesPaidGroupInfo> deptList;

    public ReportsExpandableListEroAdapter(Context context, ArrayList<FeesPaidGroupInfo> deptList) {
