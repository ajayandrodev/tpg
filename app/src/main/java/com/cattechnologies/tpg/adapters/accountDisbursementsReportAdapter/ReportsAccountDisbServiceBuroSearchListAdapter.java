...
public class ReportsAccountDisbServiceBuroSearchListAdapter extends RecyclerView.Adapter<ReportsAccountDisbServiceBuroSearchListAdapter.ReportsViewHolder> {
    List<ReportAccountDisbServiceBuroSearchNew> reportsList;
    String title;
    ...
    @Override
    public ReportsAccountDisbServiceBuroSearchListAdapter.ReportsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_list_row, parent, false);
        ReportsAccountDisbServiceBuroSearchListAdapter.ReportsViewHolder reportsViewHolder
                = new ReportsAccountDisbServiceBuroSearchListAdapter.ReportsViewHolder(itemView);
        return reportsViewHolder;
    }

    @Override
    public void onBindViewHolder(ReportsAccountDisbServiceBuroSearchListAdapter.ReportsViewHolder holder, int position) {
