...
import com.cattechnologies.tpg.model.accountDisbursementModel.ReportAccountDisbServiceBuroSearchSortNew;
...
public class ReportsAccountDisbServiceBuroSearchSortListAdapter extends RecyclerView.Adapter<ReportsAccountDisbServiceBuroSearchSortListAdapter.ReportsViewHolder> {
    List<ReportAccountDisbServiceBuroSearchSortNew> reportsList;
    String title;
    private ItemClickListener clickListener;
    String index;
    Context mContext;

    public ReportsAccountDisbServiceBuroSearchSortListAdapter(Context mContext, List<ReportAccountDisbServiceBuroSearchSortNew> reportsList, String title) {
    ...
    @Override
    public ReportsAccountDisbServiceBuroSearchSortListAdapter.ReportsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.report_list_row, parent, false);
        ReportsAccountDisbServiceBuroSearchSortListAdapter.ReportsViewHolder reportsViewHolder
                = new ReportsAccountDisbServiceBuroSearchSortListAdapter.ReportsViewHolder(itemView);
        return reportsViewHolder;
    }

    @Override
    public void onBindViewHolder(ReportsAccountDisbServiceBuroSearchSortListAdapter.ReportsViewHolder holder, int position) {
