package com.cattechnologies.tpg.adapters.checkToPrintReportAdapter;
...
import com.cattechnologies.tpg.fragments.checksToPrintReport.ReportsCheckToPrintDetailsFragment;
...
public class ReportsCheckListToPrintAdapter extends RecyclerView.Adapter<ReportsCheckListToPrintAdapter.ReportsViewHolder> {
    List<Reports> reportsList;
    Context mContext;
    String title;

    public ReportsCheckListToPrintAdapter(Context mContext, List<Reports> reportsList, String title) {
        ...
        public ReportsViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Fragment fragment = ReportsCheckToPrintDetailsFragment.newInstance(title);
