...
public class ReportsEroDepositExpandableadapter extends BaseExpandableListAdapter {
    private Context mcontext;
    private List<String> parent;
    private HashMap<String, List<String>> bind_and_display;

    public ReportsEroDepositExpandableadapter(Context context, List<String> listDataHeader,
