...
public class MyProfileExpandableListEnrAdapter extends BaseExpandableListAdapter {
    private Context context;
    private ArrayList<MyProfileGroupEnrollInfo> deptList;
    String type;
    PreferencesManager preferencesManager;

    public MyProfileExpandableListEnrAdapter(Context context, ArrayList<MyProfileGroupEnrollInfo> deptList, String type) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View view, ViewGroup parent) {
        ...
        MyProfileGroupEnrollInfo headerInfo = (MyProfileGroupEnrollInfo) getGroup(groupPosition);
        if (view == null) {
