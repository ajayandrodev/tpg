...
import com.cattechnologies.tpg.Fragments.ReportsEroDepositsDetailsFragment;
...
public class ReportsEroListAdapter extends RecyclerView.Adapter<ReportsEroListAdapter.ReportsViewHolder> {
    List<Reports> reportsList;
    Context mContext;
    String title;

    public ReportsEroListAdapter(Context mContext, List<Reports> reportsList, String title) {
